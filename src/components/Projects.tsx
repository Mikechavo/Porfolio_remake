      ...
      <div className="bg-white">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-500">
              A basic Frontend multipage website I created for a project at WGU. This is a React app made with Javascript, HTML, CSS, and Bootstrap. This app give users a little information about Texas and the main cities inside of Texas.
            </p>

            <dl className="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">

              <div className="border-t border-gray-200 pt-4">
                <Button><a href="https://github.com/Mikechavo/schoolMultipage">
                  Source Code
                </a>
                </Button>
                {/* <dd className="mt-2 text-sm text-gray-500"> Python, Django framework(maybe put an image here)</dd> */}
              ...
              <div className="border-t border-gray-200 pt-4">
                <Button><a href="https://mikestexasmultipagewebsite.netlify.app/">
                  Live Site
                </a>
                </Button>
                {/* <dd className="mt-2 text-sm text-gray-500"> Python, Django framework(maybe put an image here)</dd> */}
